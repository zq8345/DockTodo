...
const STRINGS = {
  en: {
    ...
    "import.skipped": "Skipped {n} duplicate entries.",
    "import.done": "Done",
    "map.title": "Map CSV columns",
    "map.hint": "We couldn't detect the tool. Tell us which column is which.",
    "map.task": "Task / description",
    "map.client": "Client",
    "map.project": "Project",
    "map.duration": "Duration (hh:mm:ss)",
    "map.durationDecimal": "Duration (hours)",
    "map.date": "Date / start",
    "map.billable": "Billable",
    "map.rate": "Rate",
    "map.amount": "Amount",
    "map.tags": "Tags",
    "map.needTask": "Map the Task column first",
    "map.needDuration": "Map a duration column (hh:mm:ss or hours)",
    "map.needDate": "Map the Date / start column",
    // confirms
  ...
  zh: {
    ...
    "import.undo": "撤销导入",
    "import.undone": "已撤销导入",
    "import.skipped": "跳过 {n} 条重复记录。",
    "import.done": "完成",
    "map.title": "映射 CSV 列",
    "map.hint": "无法识别来源工具，请指定各列的含义。",
    "map.task": "任务 / 描述",
    "map.client": "客户",
    "map.project": "项目",
    "map.duration": "时长 (hh:mm:ss)",
    "map.durationDecimal": "时长 (小时)",
    "map.date": "日期 / 开始",
    "map.billable": "计费",
    "map.rate": "费率",
    "map.amount": "金额",
    "map.tags": "标签",
    "map.needTask": "请先映射任务列",
    "map.needDuration": "请映射时长列 (hh:mm:ss 或小时)",
    "map.needDate": "请映射日期 / 开始列",
